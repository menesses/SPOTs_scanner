...
%         the controller following an alarm. CURRENTLY NOT USED
    ...
    % Draw crosshair
    rectangle(ax,'Position',[960/2-25 687/2-25 50 50],'Curvature',1);
    line(ax,[0 1]*960,[0.5 0.5]*687,'Color','k');
    line(ax,[0.5 0.5]*960,[0 1]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.1 0.1]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.2 0.2]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.3 0.3]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.4 0.4]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.6 0.6]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.7 0.7]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.8 0.8]*687,'Color','k');
    line(ax,[0.45 0.55]*960,[0.9 0.9]*687,'Color','k');
    line(ax,[0.1 0.1]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.2 0.2]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.3 0.3]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.4 0.4]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.6 0.6]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.7 0.7]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.8 0.8]*960,[0.45 0.55]*687,'Color','k');
    line(ax,[0.9 0.9]*960,[0.45 0.55]*687,'Color','k');
